 ...
 *
 * Este wrapper delega al nuevo ejecutor para evitar folios duplicados.
 *
 * CLI:  php run_seed_nominas_demo.php apply|revert
...
if ($isCli) {
    fwrite(STDERR, "Aviso: run_seed_nominas_demo.php está obsoleto. Delegando a run_seed_nominas_reset_demo.php\n");
}
