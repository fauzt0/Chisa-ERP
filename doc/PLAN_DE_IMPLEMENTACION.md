...
R: El formato debe ser similar al de las hojas de referencia, solo debe ser amigable y facil de usar, pero con un formato similar ya que principalmente es para consultas y para generar los "futuros lotes" que se piden desde el área de ventas y proyectos.
...
R: El campo de m2 por kg es por formulacion. Sigue la propuesta existente, en caso de que esto cambie, lo podemos ajustar, pero la idea es que cuantos más datos tenga el sistema, más inteligente y preciso sea. Esta nueva funcionalidad se implementara.
...
R: Se manejan como productos hijos (variantes en la BD), pero optimizalo de la mejor manera para que no sea confuso para usuarios.
